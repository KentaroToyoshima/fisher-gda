...
def main(args):
    ...
    #shape = allocations_linear_ref.shape
    #allocations_linear_ref = np.full(shape, 1)
    #shape = prices_linear_ref.shape
    #prices_linear_ref = np.full(shape, 1)
    #収束先
    ...
    #shape = allocations_cd_ref.shape
    #allocations_cd_ref = np.full(shape, 1)
    #shape = prices_cd_ref.shape
    #prices_cd_ref = np.full(shape, 1)
    #収束先
    ...
    #shape = allocations_leontief_ref.shape
    #allocations_leontief_ref = np.full(shape, 1)
    #shape = prices_leontief_ref.shape
    #prices_leontief_ref = np.full(shape, 1)
