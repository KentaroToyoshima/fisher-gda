...
def main(args):
    ...
    allocations_linear_ref = np.full_like(allocations_linear_ref2, 0.1)
    ...
    allocations_cd_ref = np.full_like(allocations_cd_ref2, 0.1)
    ...
    allocations_leontief_ref = np.full_like(allocations_leontief_ref2, 0.1)
